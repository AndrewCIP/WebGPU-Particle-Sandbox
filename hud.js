...
class HUDManager {
  ...
  createModeSection() {
    ...
    const modes = [
      ...
      { id: "mode-5", label: "5: Cursor Follow", value: 5 },
    ];
  ...
  createInfoSection() {
    ...
    info.innerHTML = `<small><strong>Mouse:</strong> Left Click = Attract | Right Click = Repel<br/><strong>Keyboard:</strong> 1-5 = Modes | ↑↓ = Force | ←→ = Damping<br/><strong>Shortcuts:</strong> [ Smaller | ] Bigger | -/+ = Count | T = Trails | R = Reset | H = Toggle HUD</small>`;
